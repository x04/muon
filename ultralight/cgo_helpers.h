...
unsigned long long ULSurfaceDefinitionGetSizeCallback_83184afe(void* user_data);
...
_Bool ULFileSystemGetFileSizeCallback_e87ad8b1(unsigned long long handle, long long* result);
...
unsigned long long ULFileSystemOpenFileCallback_bbb19604(ULString path, _Bool open_for_writing);

// ULFileSystemCloseFileCallback_c90ac2e5 is a proxy for callback ULFileSystemCloseFileCallback.
void ULFileSystemCloseFileCallback_c90ac2e5(unsigned long long handle);

// ULFileSystemReadFromFileCallback_bc1997bc is a proxy for callback ULFileSystemReadFromFileCallback.
long long ULFileSystemReadFromFileCallback_bc1997bc(unsigned long long handle, char* data, long long length);
...
JSValueRef JSObjectCallAsFunctionCallback_89f9469b(JSContextRef ctx, JSObjectRef function, JSObjectRef thisObject, unsigned long long argumentCount, JSValueRef* arguments, JSValueRef* exception);

// JSObjectCallAsFunctionCallbackEx_9f036e3c is a proxy for callback JSObjectCallAsFunctionCallbackEx.
JSValueRef JSObjectCallAsFunctionCallbackEx_9f036e3c(JSContextRef ctx, JSClassRef jsClass, JSStringRef className, JSObjectRef function, JSObjectRef thisObject, unsigned long long argumentCount, JSValueRef* arguments, JSValueRef* exception);

// JSObjectCallAsConstructorCallback_45f4b71f is a proxy for callback JSObjectCallAsConstructorCallback.
JSObjectRef JSObjectCallAsConstructorCallback_45f4b71f(JSContextRef ctx, JSObjectRef constructor, unsigned long long argumentCount, JSValueRef* arguments, JSValueRef* exception);

// JSObjectCallAsConstructorCallbackEx_a563df4 is a proxy for callback JSObjectCallAsConstructorCallbackEx.
JSObjectRef JSObjectCallAsConstructorCallbackEx_a563df4(JSContextRef ctx, JSClassRef jsClass, JSObjectRef constructor, unsigned long long argumentCount, JSValueRef* arguments, JSValueRef* exception);
